...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-success').click(function () {
            Swal.fire({
                title: 'Berhasil!',
                text: 'Silahkan tunggu persetujuan admin selama +-3 hari kerja.',
                icon: 'success',
        ...
        $('#sa-success2').click(function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'profile-mahasiswa.php';
                }
            });
        });
        ...
        $('#sa-error').click(function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'registrasi-mahasiswa.php';
                }
            });    
        });

        $('#sa-error2').click(function () {
            Swal.fire({
                title: 'Gagal!',
        ...
        $('#sa-error3r').click(function () {
            Swal.fire({
                title: 'Gagal!',
                text: 'Kuota beasiswa anda sudah habis!',
                icon: 'error',
                confirmButtonClass: 'btn btn-danger',
                confirmButtonText: 'OK'
            }).then((result) => {
