                                        ...
                                        <div class="page-title-box">
                                            <div class="btn-group float-right">
                                                <ol class="breadcrumb hide-phone p-0 m-0">
                                                    <li class="breadcrumb-item"><a href="index-admin.php">Admin Beasiswa ITTP</a></li>
                                                    <li class="breadcrumb-item active">List Pengajuan</li>
                                                </ol>
                                            </div>
                                            <h4 class="page-title">List Pengajuan Beasiswa menunggu verifikasi ITTP</h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    <div class="col-sm-12">
                                        <div class="page-title-box">
                                            ...
                                            <h4 class="page-title">List seluruh Pengajuan Beasiswa ITTP</h4>
                                        </div>
                                    </div>
                                </div>
